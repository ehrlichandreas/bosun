...
import { SCRIPT_ROOT } from "./paths.mjs";
...
function check(value         , schema        , path        , field        )            {
  const problems            = [];
...
export function validate(entry         , version        )            {
...
export function missingFields(entry         , version        )           {
